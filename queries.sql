WITH FollowUp AS (select follow_up.encounter_id,
                         ...
                         who_knows_your_child_s_hiv_positive,
...
select sex,
       ...
       CEIL(TIMESTAMPDIFF(MONTH, art_start_date, END_DATE)) AS MonthsOnART,
       who_knows_your_child_s_hiv_positive as ChildDisclosueStatus,
       FollowUp.PatientId,
